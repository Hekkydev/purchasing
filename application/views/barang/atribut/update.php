...
<section class="content">
    ...
    <div class="box">
      ...
      <form action="<?php echo site_url('admin/barang/update_atribut_proses')?>" method="post" autocomplete="off">
        <div class="box-body">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <input type="hidden" name="id_item_atribut" value="<?php echo $atrib->id_item_atribut?>">
              <input type="text" name="nama_atribut" class="form-control input-sm" value="<?php echo $atrib->nama_atribut?>"  placeholder="Tentukan nama atribut" required="">
            </div>
        ...
        <div class="box-footer">
            ...
            <a href="<?php echo site_url('admin/barang/atribut')?>" class="pull-right btn btn-default btn-sm">Kembali</a>
        </div><!-- /.box-footer-->

...
<section class="content">
    ...
    <div class="box">
      ...
      <form action="<?php echo site_url('admin/barang/add_atribut_proses')?>" method="post" autocomplete="off">
        <div class="box-body">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <input type="text" name="nama_atribut" class="form-control input-sm" value=""  placeholder="Tentukan nama atribut" required="">
            </div>

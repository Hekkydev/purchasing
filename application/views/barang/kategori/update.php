...
<section class="content">
    ...
    <div class="box">
      ...
      <form action="<?php echo site_url('admin/barang/update_kategori_proses')?>" method="post" autocomplete="off">
        <div class="box-body">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <input type="hidden" name="id_item_category" value="<?php echo $cat->id_item_category;?>">
              <input type="text" name="nama_category" class="form-control input-sm" value="<?php echo $cat->nama_category;?>"  placeholder="Tentukan nama kategori" required="">
            </div>

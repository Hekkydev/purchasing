...
<section class="content">
    ...
    <div class="box">
            ...
            <div class="box-tools pull-right">
              ...
              <form class="" action="index.html" method="post">
                <div class="input-group input-group-sm" style="width: 550px;">
                    ...
                    <input type="text" name="table_search" class="form-control pull-right" placeholder="nama barang">
        ...
        <div class="box-body">
           <?php $this->load->view('report/laporan/barang'); ?>
        </div><!-- /.box-body -->
      ...
      <div class="modal-body">
        <div class="row">
          <div style="margin-right:-10px;margin-left:-10px;">
            <iframe id="laporan_src" src="<?php echo base_url(''.base_akses().'report/get_pdf_barang/barng.pdf')?>" class="col-lg-12" style="height:500px;" frameborder="0"></iframe>

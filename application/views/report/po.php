        ...
        <div class="box-body">
           <div>
                    <div class="row">
                        ...
                        <div class="col-md-12" >
                                <div id="laporan" class="well" style="padding:0px; height:400px;overflow-y: scroll;">
                                  <?php $this->load->view('report/laporan/po'); ?>
                                </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function get_data() {
        ...
        var tahun = $('#tahun').val();
        $.ajax({
            url:"<?php echo site_url(''.base_akses().'report/data_rekap_po');?>",
            type:"GET",
            cache:false,
    ...
    function pdf_ajax() {
        ...
        var tahun = $('#tahun').val();
        $.ajax({
            url:"<?php echo site_url(''.base_akses().'report/data_rekap_po_laporan');?>",
            type:"GET",
            cache:false,
            data:{jenis_rekap:jenis_rekap,tanggal:tanggal,bulan:bulan,tahun:tahun},
            success:function(data) {
